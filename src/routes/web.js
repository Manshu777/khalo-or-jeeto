...
const initWebRouter = (app) => {
  ...
  router.post(
    "/wallet/paynow/wepay",
    middlewareController,
    paymentController.initiateWepayPayment,
  );
  ...
  router.post(
    "/api/webapi/direct-recharge",
    middlewareController,
    userController.directRecharge,
  );
  router.post(
  ...
  router.get('/api/manshu', winGoController.getHighestBet);
  router.get('/api/betting-stats/most-number-bets', winGoController.getMostNumberBets);
  router.post(
    "/api/webapi/confirm_recharge_usdt",
    middlewareController,
    userController.confirmUSDTRecharge,
  ...
  router.post(
    "/admin/manager/create/demo",
    adminController.middlewareAdminController,
    adminController.registerdemo,
  );
  router.post(
  ...
  router.get(
    "/admin/manager/demostatistical",
    adminController.middlewareAdminController,
    adminController.demostatistical,
  );
  router.get(
  ...
  router.post(
    "/api/webapi/admin/listdemo",
    adminController.middlewareAdminController,
    adminController.listDEMO,
  );
  router.post(
  ...
  router.post(
    "/api/webapi/admin/lockwithdraw",
    adminController.middlewareAdminController,
    adminController.lockwithdraw,
  ); // get info account
